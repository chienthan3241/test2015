...
public class ImageAdapter extends BaseAdapter {
    ...
    private int[] mThumbIds = {
            R.drawable.billboard, R.drawable.itunes_store,
    ...
    private String[] contents = {
    		"Billboard Hot 100","Itunes Top Selling","Google Play Charts","Spotify Charts","Amazon Top Selling","Napster-Rhapsody Charts","Lastfm Radio Charts"
    };
